...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create IdType FHIR object
 */
public class IdTypeFactory extends TypeFactory {

    public IdTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof IdType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getIdType(path, params, context);
    }
}
