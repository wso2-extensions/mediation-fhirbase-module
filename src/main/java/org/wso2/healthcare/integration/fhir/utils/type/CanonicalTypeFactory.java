...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create CanonicalType FHIR object
 */
public class CanonicalTypeFactory extends TypeFactory {

    public CanonicalTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof CanonicalType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getCanonicalType(path, params, context);
    }
}
