 ...
 */
public class FHIRAddBundleEntry extends FHIRAddOperation {

    public FHIRAddBundleEntry() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        if (bundle != null) {
            bundle.addEntry(configuredParams, fhirConnectorContext);
        } else {
