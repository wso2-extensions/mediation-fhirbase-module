...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Duration FHIR object
 */
public class DurationFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDuration(path, params, context);
    }
}
