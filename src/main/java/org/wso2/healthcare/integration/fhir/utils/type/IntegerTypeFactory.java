...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create IntegerType FHIR object
 */
public class IntegerTypeFactory extends TypeFactory {

    public IntegerTypeFactory() {
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getIntegerType(path, params, context);
    }
}
