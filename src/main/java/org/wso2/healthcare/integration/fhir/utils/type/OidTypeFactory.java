...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create OidType FHIR object
 */
public class OidTypeFactory extends TypeFactory {

    public OidTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof OidType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getOidType(path, params, context);
    }
}
