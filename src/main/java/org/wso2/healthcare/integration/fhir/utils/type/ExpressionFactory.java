...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Expression FHIR object
 */
public class ExpressionFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getExpression(path, params, context);
    }
}
