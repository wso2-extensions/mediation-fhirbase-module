...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create DecimalType FHIR object
 */
public class DecimalTypeFactory extends TypeFactory {

    public DecimalTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof DecimalType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDecimalType(path, params, context);
    }
}
