...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create StringType FHIR object
 */
public class StringTypeFactory extends TypeFactory {

    public StringTypeFactory() {
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getStringType(path, params, context);
    }
}
