...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create TimeType FHIR object
 */
public class TimeTypeFactory extends TypeFactory {

    public TimeTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof TimeType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getTimeType(path, params, context);
    }
}
