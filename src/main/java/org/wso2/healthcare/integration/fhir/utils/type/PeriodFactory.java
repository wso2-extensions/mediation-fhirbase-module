...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Period FHIR object
 */
public class PeriodFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getPeriod(path, params, context);
    }
}
