...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create PositiveIntType FHIR object
 */
public class PositiveIntTypeFactory extends TypeFactory {

    public PositiveIntTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof PositiveIntType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getPositiveIntType(path, params, context);
    }
}
