...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create UnsignedIntType FHIR object
 */
public class UnsignedIntTypeFactory extends TypeFactory {

    public UnsignedIntTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof UnsignedIntType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getUnsignedIntType(path, params, context);
    }
}
