...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create RelatedArtifact FHIR object
 */
public class RelatedArtifactFactory extends TypeFactory {

    public RelatedArtifactFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof RelatedArtifact;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getRelatedArtifact(path, params, context);
    }
}
