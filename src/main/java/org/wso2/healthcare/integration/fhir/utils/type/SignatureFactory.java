...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Signature FHIR object
 */
public class SignatureFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getSignature(path, params, context);
    }
}
