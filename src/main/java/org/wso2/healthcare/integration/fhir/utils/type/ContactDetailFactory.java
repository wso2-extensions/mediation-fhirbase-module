...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create ContactDetail FHIR object
 */
public class ContactDetailFactory extends TypeFactory {

    public ContactDetailFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof ContactDetail;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getContactDetail(path, params, context);
    }
}
