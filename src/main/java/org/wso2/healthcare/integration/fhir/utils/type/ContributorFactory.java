...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Contributor FHIR object
 */
public class ContributorFactory extends TypeFactory {

    public ContributorFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Contributor;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getContributor(path, params, context);
    }
}
