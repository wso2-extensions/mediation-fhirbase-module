...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Quantity FHIR object
 */
public class QuantityFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getQuantity(path, params, context);
    }
}
