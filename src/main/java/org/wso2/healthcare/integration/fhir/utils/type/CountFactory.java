...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Count FHIR object
 */
public class CountFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getCount(path, params, context);
    }
}
