...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Dosage FHIR object
 */
public class DosageFactory extends TypeFactory {

    public DosageFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Dosage;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDosage(path, params, context);
    }
}
