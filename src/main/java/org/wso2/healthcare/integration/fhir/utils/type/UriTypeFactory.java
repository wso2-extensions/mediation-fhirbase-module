...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create UriType FHIR object
 */
public class UriTypeFactory extends TypeFactory {

    public UriTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof UriType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getUriType(path, params, context);
    }
}
