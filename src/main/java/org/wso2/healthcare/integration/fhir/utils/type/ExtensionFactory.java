...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Extension FHIR object
 */
public class ExtensionFactory extends TypeFactory {

    public ExtensionFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Extension;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getExtension(path, params, context);
    }
}
