 ...
 */
public class FHIRSetBundleTotal extends FHIRAddOperation {

    public FHIRSetBundleTotal() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        if (bundle != null) {
            bundle.setTotal(configuredParams, fhirConnectorContext);
        } else {
