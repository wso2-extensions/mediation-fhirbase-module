...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create HumanName FHIR object
 */
public class HumanNameFactory extends TypeFactory {

    public HumanNameFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof HumanName;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getHumanName(path, params, context);
    }
}
