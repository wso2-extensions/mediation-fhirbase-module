...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Attachment FHIR object
 */
public class AttachmentFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getAttachment(path, params, context);
    }
}
