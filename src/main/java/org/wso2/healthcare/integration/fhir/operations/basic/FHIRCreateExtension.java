...
/**
 * Operation to create FHIR Extension
 */
public class FHIRCreateExtension extends FHIRCreateAndAddDataTypeOperation {
    ...
    protected DataType executeAndReturn(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        return new SpecialPurposeDataType(objectId, extension);
    }
