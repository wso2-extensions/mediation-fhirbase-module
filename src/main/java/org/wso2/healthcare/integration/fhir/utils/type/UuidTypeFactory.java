...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create UuidType FHIR object
 */
public class UuidTypeFactory extends TypeFactory {

    public UuidTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof UuidType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getUuidType(path, params, context);
    }
}
