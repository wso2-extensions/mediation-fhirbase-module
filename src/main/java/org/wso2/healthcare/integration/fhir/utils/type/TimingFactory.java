...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Timing FHIR object
 */
public class TimingFactory extends TypeFactory {

    public TimingFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Timing;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getTiming(path, params, context);
    }
}
