...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Ratio FHIR object
 */
public class RatioFactory extends TypeFactory {

    public RatioFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Ratio;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getRatio(path, params, context);
    }
}
