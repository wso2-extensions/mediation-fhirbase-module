...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create ContactPoint FHIR object
 */
public class ContactPointFactory extends TypeFactory {

    public ContactPointFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof ContactPoint;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getContactPoint(path, params, context);
    }
}
