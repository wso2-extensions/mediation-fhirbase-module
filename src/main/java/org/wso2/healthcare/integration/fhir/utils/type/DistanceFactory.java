...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Distance FHIR object
 */
public class DistanceFactory extends TypeFactory {

    public DistanceFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Distance;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDistance(path, params, context);
    }
}
