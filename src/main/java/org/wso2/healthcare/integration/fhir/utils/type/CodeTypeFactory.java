...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create CodeType FHIR object
 */
public class CodeTypeFactory extends TypeFactory {

    public CodeTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof CodeType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getCodeType(path, params, context);
    }
}
