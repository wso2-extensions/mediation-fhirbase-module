...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Meta FHIR object
 */
public class MetaFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getMeta(path, params, context);
    }
}
