 ...
 */
public class FHIRSetBundleSignature extends FHIRAddOperation {

    public FHIRSetBundleSignature() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        if (bundle != null) {
            bundle.setSignature(configuredParams, fhirConnectorContext);
        } else {
