...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create MarkdownType FHIR object
 */
public class MarkdownTypeFactory extends TypeFactory {

    public MarkdownTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof MarkdownType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getMarkdownType(path, params, context);
    }
}
