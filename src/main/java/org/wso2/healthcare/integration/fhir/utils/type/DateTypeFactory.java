...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create DateType FHIR object
 */
public class DateTypeFactory extends TypeFactory {

    public DateTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof DateType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDateType(path, params, context);
    }
}
