...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Identifier FHIR object
 */
public class IdentifierFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getIdentifier(path, params, context);
    }
}
