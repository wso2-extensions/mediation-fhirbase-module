...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create SimpleQuantity FHIR object
 */
public class SimpleQuantityFactory extends TypeFactory {

    public SimpleQuantityFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof SimpleQuantity;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getSimpleQuantity(path, params, context);
    }
}
