 ...
 */
public class FHIRAddBundleLink extends FHIRAddOperation {

    public FHIRAddBundleLink() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        if (bundle != null) {
            bundle.addLink(configuredParams, fhirConnectorContext);
        } else {
