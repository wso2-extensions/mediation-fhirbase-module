...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Range FHIR object
 */
public class RangeFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getRange(path, params, context);
    }
}
