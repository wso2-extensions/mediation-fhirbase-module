 ...
 */
public class FHIRCreateOperationOutcome extends FHIRCreateOperation {

    public FHIRCreateOperationOutcome() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        OperationOutcome operationOutcome = new OperationOutcome(null, configuredParams, fhirConnectorContext);
        fhirConnectorContext.createResource(operationOutcome);
    }
