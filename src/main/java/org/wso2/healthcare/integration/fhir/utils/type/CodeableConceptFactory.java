...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create CodeableConcept FHIR object
 */
public class CodeableConceptFactory extends TypeFactory {

    public CodeableConceptFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof CodeableConcept;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getCodeableConcept(path, params, context);
    }
}
