...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create InstantType FHIR object
 */
public class InstantTypeFactory extends TypeFactory {

    public InstantTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof InstantType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getInstantType(path, params, context);
    }
}
