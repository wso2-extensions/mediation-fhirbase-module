 ...
 */
public class FHIRSetBundleTimestamp extends FHIRAddOperation {

    public FHIRSetBundleTimestamp() {
    }
    ...
    protected void execute(MessageContext messageContext, FHIRConnectorContext fhirConnectorContext,
        ...
        if (bundle != null) {
            bundle.setTimestamp(configuredParams, fhirConnectorContext);
        } else {
