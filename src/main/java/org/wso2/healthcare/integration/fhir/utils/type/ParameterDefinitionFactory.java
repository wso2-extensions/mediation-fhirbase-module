...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create ParameterDefinition FHIR object
 */
public class ParameterDefinitionFactory extends TypeFactory {

    public ParameterDefinitionFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof ParameterDefinition;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getParameterDefinition(path, params, context);
    }
}
