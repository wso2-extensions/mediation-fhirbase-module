...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create MoneyQuantity FHIR object
 */
public class MoneyQuantityFactory extends TypeFactory {

    public MoneyQuantityFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof MoneyQuantity;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getMoneyQuantity(path, params, context);
    }
}
