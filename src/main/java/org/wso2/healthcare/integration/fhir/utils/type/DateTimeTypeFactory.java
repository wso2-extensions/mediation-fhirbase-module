...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create DateTimeType FHIR object
 */
public class DateTimeTypeFactory extends TypeFactory {

    public DateTimeTypeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof DateTimeType;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDateTimeType(path, params, context);
    }
}
