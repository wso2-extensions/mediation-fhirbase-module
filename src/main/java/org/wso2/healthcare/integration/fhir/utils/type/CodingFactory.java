...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Coding FHIR object
 */
public class CodingFactory extends TypeFactory {

    public CodingFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Coding;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getCoding(path, params, context);
    }
}
