...
/**
 * This class is used to retrieve registered template function instances.
 */
public class TemplateFunctionFactory {
    ...
    /**
     * This method is used to retrieve the template function
     *
     * @param functionName  Function name
     * @return Registered template function
     */
    public TemplateFunction createFunction(String functionName) {
        switch (functionName) {
            case "map":
