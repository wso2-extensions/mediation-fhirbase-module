...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Age FHIR object
 */
public class AgeFactory extends TypeFactory {

    public AgeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Age;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getAge(path, params, context);
    }
}
