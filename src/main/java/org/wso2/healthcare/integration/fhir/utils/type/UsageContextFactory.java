...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create UsageContext FHIR object
 */
public class UsageContextFactory extends TypeFactory {

    public UsageContextFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof UsageContext;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getUsageContext(path, params, context);
    }
}
