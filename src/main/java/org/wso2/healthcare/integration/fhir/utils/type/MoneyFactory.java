...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Money FHIR object
 */
public class MoneyFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getMoney(path, params, context);
    }
}
