...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Address FHIR object
 */
public class AddressFactory extends TypeFactory {
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getAddress(path, params, context);
    }
}
