...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create DataRequirement FHIR object
 */
public class DataRequirementFactory extends TypeFactory {

    public DataRequirementFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof DataRequirement;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getDataRequirement(path, params, context);
    }
}
