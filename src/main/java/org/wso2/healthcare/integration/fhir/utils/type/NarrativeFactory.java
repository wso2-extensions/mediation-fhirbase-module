...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create Narrative FHIR object
 */
public class NarrativeFactory extends TypeFactory {

    public NarrativeFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof Narrative;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getNarrative(path, params, context);
    }
}
