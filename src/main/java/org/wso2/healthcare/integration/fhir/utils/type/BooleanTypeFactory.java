...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create BooleanType FHIR object
 */
public class BooleanTypeFactory extends TypeFactory {

    public BooleanTypeFactory() {
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getBooleanType(path, params, context);
    }
}
