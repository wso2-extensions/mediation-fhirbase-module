...
/**
 * Note: Generated Code
 * Impl class of type factory implementations used to create SampledData FHIR object
 */
public class SampledDataFactory extends TypeFactory {

    public SampledDataFactory() {
    }

    public boolean isInstance(Object object) {
        return object instanceof SampledData;
    }
    ...
    public Type createObject(String path,
        ...
        return FHIRDataTypeUtils.getSampledData(path, params, context);
    }
}
