 ...
 * which is immediately under [healthcare.fhir.terminology] tag
 */
public class FHIRTerminologyConfig {
    ...
    public String getCodeSystemURIPrefix() {
        ...
        return codeSystemURIPrefix;
    }

    public void setCodeSystemURIPrefix(String codeSystemURIPrefix) {

        this.codeSystemURIPrefix = codeSystemURIPrefix;
    }
}
