...
/**
 * Abstract class of common search parameter
 */
public abstract class AbstractCommonSearchParameter implements SearchParameter {

    private boolean active = true;
    private final String name;

    public AbstractCommonSearchParameter(String name) {
        this.name = name;
    }
    ...
    public String getType() {
        ...
        return Constants.FHIR_SEARCH_TYPE_COMMON;
    }
