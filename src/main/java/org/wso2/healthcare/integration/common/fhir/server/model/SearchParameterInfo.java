...
/**
 * Implementations Contains different search parameter information
 */
public abstract class SearchParameterInfo extends AbstractSerializableInfo {

    private String type;

    public SearchParameterInfo(String type) {
    ...
    public OMElement serialize() {
        ...
        element.addChild(createSimpleElement("type", getType()));
        return element;
    }
