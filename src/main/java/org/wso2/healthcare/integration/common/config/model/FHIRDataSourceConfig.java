...
/**
 * Class containing configurations related for FHIR data source
 * which is immediately under [healthcare.fhir.datasource] tag
 */
public class FHIRDataSourceConfig {
    ...
    public void setMatchAnyPattern(String matchAnyPattern) {
