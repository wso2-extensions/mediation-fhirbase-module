...
import org.wso2.healthcare.integration.common.fhir.server.FHIRAPIPostProcessor;
import org.wso2.healthcare.integration.common.utils.HealthcareUtils;

/**
 * FHIR API Post Processor mediator implementation
 */
public class FHIRAPIPostProcessorMediator extends AbstractMediator {

    private static final Log LOG = LogFactory.getLog(FHIRAPIPostProcessorMediator.class);
    private final FHIRAPIPostProcessor searchControlProcessor;

    public FHIRAPIPostProcessorMediator() {
        this.searchControlProcessor = new FHIRAPIPostProcessor();
    }
    ...
    public boolean mediate(MessageContext messageContext) {
        ...
        try {
            this.searchControlProcessor.process(messageContext);
            ...
            String errMessage = "Error occurred while executing search control processor for resource : " +
