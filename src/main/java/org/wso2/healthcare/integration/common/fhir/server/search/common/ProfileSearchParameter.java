...
public class ProfileSearchParameter extends AbstractCommonSearchParameter {
    ...
    public ArrayList<SearchParameterInfo> preProcess(ResourceAPI resourceAPI,
        ...
        searchParameterInfoList.add(
                new SimpleSearchParameterInfo(Constants.FHIR_SEARCH_PARAM_PROFILE, requestInfo.getFhirInfo().getProfile()));
