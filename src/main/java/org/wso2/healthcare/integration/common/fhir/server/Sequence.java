...
/**
 * Represent synapse sequence details which responsible of handling relevant request type for a FHIR profile
 */
public class Sequence {
    ...
    public Sequence(String name, FHIRAPIInteraction interaction) {
